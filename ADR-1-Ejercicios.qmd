...
**6. Usando la matriz "presencia" que creaste y la función `apply()`, calcula la prevalencia de cada especie (i.e. el número de veces que ocurre con respecto al número total de sitios).**


**7. Escribe la matriz "presencia" que creaste en un archivo "Presencia.xlsx".**
