...
**1. Dibuja un histograma del vector `a` que creaste en los Ejercicios de la parte 1.**
...
**2. Cambia el color de las barras con la opción `col` y cambia el color de los cuadros con la opción de `border`.**

**3. Usa `abline()` para dibujar la media de la distribución como una línea vertical punteada.**
