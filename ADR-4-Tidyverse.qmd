...
* Cada observación está en su propia
* Se accede a las variables como vectores
...
fruit <- paste0("fruit_", fruit)

fruit <- str_replace(fruit, "fruit_", "")
```
...
mtcars |> summarize(across(everything(), mean))
```
